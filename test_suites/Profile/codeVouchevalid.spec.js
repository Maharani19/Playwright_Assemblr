...
test.describe('Test Case Profile', () => {
    ...
    test("voucher valid", async ({ page }) => {
        ...
        await page.frameLocator('iframe[title="payment-pwa"]').getByPlaceholder('Voucher Code').fill('schoolpremiumfree');
        await page.waitForTimeout(300)
        // if (home.btnapply.click()) {
        //     await page.waitForTimeout(10000)
        //     await home.valid.disable.false()
        //     await home.valid.click()
        //     await home.btnpurchase.click()
           
        // } else {
        //     await page.waitForTimeout(10000)
        //     home.invalid = true;
        //     home.btnpurchase.disable();          
        // }
